...
import com.example.myrecipes.activity.RecipeFragment.Companion.EditRecipeArgs
import com.example.myrecipes.data.RecipeViewModel
import com.example.myrecipes.data.StepEditAdapter
import com.example.myrecipes.databinding.FragmentNewRecipeBinding
import com.example.myrecipes.util.EditStepArgs
...
class NewRecipeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        requireActivity().title = getString(R.string.new_recipe)
